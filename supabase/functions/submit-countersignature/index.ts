// Token-gated, public. Accepts the flattened final PDF (participant's
// signature + the Authorised Person's, both baked in by the client), stores
// it, and flips status to FullyExecuted -- the end of the signing workflow.
